...
<link href="<%=basePath%>static/css/waitMe.min.css" rel="stylesheet" type="text/css" />
		...
		<div class="container">
			<div class="row ">
				...
				<div id="clock" class="light">
					...
					<div id="welcomemsg">
						欢迎光临<span style="font-size:1.5em;color:#4B8A08"> 去K书 </span>，<div style="color:#0174DF">订位请刷卡，当前时间是</div>
					</div>
					<div class="display">
						<div class="date"></div>
