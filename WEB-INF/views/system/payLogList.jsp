...
<body style="font-family: '微软雅黑'">
	<div id="tb" style="padding: 5px; height: auto">
		<form id="searchFrom" action=""> 
			...
			<input type="text" name="filter_LIKES_goodsName"
				class="easyui-validatebox" data-options="width:150,prompt: '产品名称'" /> 
			<br />
			<input type="text" name="filter_GED_createDatetime" class="easyui-my97" datefmt="yyyy-MM-dd" data-options="width:150,prompt: '开始订单时间(范围之内)'"/>
			<input type="text" id="endTime" name="filter_LED_createDatetime" class="easyui-my97" datefmt="yyyy-MM-dd" data-options="width:150,prompt: '结束订单时间(范围之内)'"/>
			<input type="text" name="filter_LIKES_bizOrderNo" 
				   class="easyui-validatebox" data-options="width:150,prompt: '订单号'" />
