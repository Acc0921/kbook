...
<body style="font-family: '微软雅黑'">
	<div id="tb" style="padding: 5px; height: auto">
		<form id="searchFrom" action="">
			...
			<select id="orderType" class="combo-text validatebox-text validatebox-f textbox" style="height: 100%;" name="filter_EQI_orderType" data-options="width:150,prompt: '账单类型">
					<option value="">全部</option>
					<option value="0">消费订单</option>
<!-- 					<option value="1">退款订单</option> -->
					<option value="2">提现订单</option>
			</select>
			<shiro:hasPermission name="sys:checkBillOrder:view">
				<a href="javascript(0)" class="easyui-linkbutton"
					iconCls="icon-search" plain="true" onclick="cx()">查询</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="sys:checkBillOrder:view">
				<a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-edit" onclick="showCheckBillOrderDeatil()">对账详情</a>
...
<%-- 			<shiro:hasPermission name="sys:payLog:exportExcel">
	...
	<script type="text/javascript">
		...
		$(function() {
			dg = $('#dg').datagrid(
					{
/* 						url : '${ctx}/system/payLog/json', */
						url : '',
					    sortOrder: 'desc',
					    sortName: 'checkBillDate',
					    fit : true,
						fitColumns : true,
						border : false,
						singleSelect:true,
						...
						columns : [ [ {
                            ...
                            field : 'doubleLocalTransactionAmount',
                            title : '本地交易金额',
                            sortable : true
                        }, {
                            field : 'doubleBankTransactionAmount',
                            title : '平台交易金额',
                            sortable : true
                        },{
                        	//对账状态 0成功 1失败
		...
		//对账详情
		function showCheckBillOrderDeatil(){
		    ...
		    var title = "对账信息";
		    var href= '${ctx}/system/payLog/dolist/'+row.store.id+'/'+row.checkBillDate+'/'+row.orderType;
		...
		function cx(){
			...
			dg.datagrid({url:'${ctx}/system/checkbill/json'});
		}
